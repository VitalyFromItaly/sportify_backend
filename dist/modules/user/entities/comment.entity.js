...
__decorate([
    typeorm_1.Column({ default: null, type: 'varchar' }),
    swagger_1.ApiProperty({ description: 'user comment' }),
    __metadata("design:type", String)
], Comment.prototype, "comment", void 0);
__decorate([
    typeorm_1.ManyToOne(() => user_entity_1.User, (user) => user.comments),
...
Comment = __decorate([
    typeorm_1.Entity({ name: 'user_comment' })
], Comment);
