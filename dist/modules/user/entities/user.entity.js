...
__decorate([
    ...
    typeorm_1.PrimaryGeneratedColumn({ comment: 'user uniq id' }),
...
__decorate([
    ...
    typeorm_1.Column({ type: 'enum', enum: user_domain_1.EGender, default: user_domain_1.EGender.OTHER }),
    class_validator_1.Min(user_domain_1.EGender.MALE),
    class_validator_1.Max(user_domain_1.EGender.OTHER),
    __metadata("design:type", Number)
...
__decorate([
    ...
    class_validator_1.IsOptional(),
    typeorm_1.Column({ type: 'enum', enum: user_domain_1.EGoal, default: user_domain_1.EGoal.WEIGHT_MAINTENANCE, nullable: false }),
...
__decorate([
    typeorm_1.Column({ default: user_domain_1.EUserStatus.NEW }),
...
__decorate([
    typeorm_1.Column({ default: user_domain_1.ELanguages.EN, enum: user_domain_1.ELanguages, type: 'enum', enumName: 'ELanguages' }),
    swagger_1.ApiProperty({ description: 'user chosen language', enum: user_domain_1.ELanguages, type: 'enum', enumName: 'ELanguages' }),
    __metadata("design:type", String)
], User.prototype, "language", void 0);
__decorate([
    swagger_1.ApiProperty({ description: 'user activities ', type: [activity_entity_1.Activity] }),
    typeorm_1.ManyToMany(() => activity_entity_1.Activity, (activity) => activity.user, { eager: true }),
    __metadata("design:type", Array)
